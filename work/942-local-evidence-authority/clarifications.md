...
## Answers
- CQ-001 → Git index membership at the candidate workspace is the durable local-authority test; filesystem existence alone is insufficient.
...
- **DEC-003** [FR-005]: Prove the boundary with independently discriminating fixtures for ignored, untracked, clean-checkout-missing, tracked, and external-receipt cases.
