...
/// build's generator version (0.24.0); fixtures declare minimums above/at/below it.
...
module ScaffoldCliCoherenceTests =
    ...
    // US2 scenario 1 (SC-002): installed 0.24.0 < declared 0.25.0 ⇒ exactly one
    ...
    // 0.25.0 > 0.24.0 numerically (components are ints, not strings) — see Fsgg.Version.
