...
module CommandSerialization =
    ...
    let writeEvidence (writer: Utf8JsonWriter) (summary: EvidenceSummary option) =
        ...
        | Some summary ->
            ...
            writer.WriteNumber("advisoryCount", summary.AdvisoryCount)
            writer.WriteNumber("blockingCount", summary.BlockingCount)
            writer.WriteNumber("classifiedObligationsUnmetCount", summary.ClassifiedObligationsUnmetCount)
            writer.WriteNumber("journeyObligationsUnmetCount", summary.JourneyObligationsUnmetCount)
    ...
    let writeVerification (writer: Utf8JsonWriter) (summary: VerificationSummary option) =
        ...
        | Some summary ->
            ...
            writer.WriteNumber("evidenceSelfAttestedCount", summary.EvidenceSelfAttestedCount)
            writer.WriteNumber("evidenceObservedCount", summary.EvidenceObservedCount)
            ...
            writer.WriteNumber("testSelfAttestedCount", summary.TestSelfAttestedCount)
            writer.WriteNumber("testObservedCount", summary.TestObservedCount)
