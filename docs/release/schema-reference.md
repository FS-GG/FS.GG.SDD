...
| `governance-handoff.json` | generated view (`governance-handoff`) / JSON | 1 | **1.2.0** | **Stable** | byte-stable | `readiness/<id>/governance-handoff.json` |
...
> `contractVersion` (`1.2.0`), which moves independently of its `schemaVersion`.
